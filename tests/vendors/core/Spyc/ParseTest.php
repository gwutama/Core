...
class ParseTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->yaml = Spyc::YAMLLoad('tests/resources/yaml/spyc.yaml');
    }
    ...
    public function testMergeHashKeys()
    {
        ...
        $Actual = Spyc::YAMLLoad('tests/resources/yaml/indent_1.yaml');
...
dog', $this->yaml['many_lines']);
    ...
    {
        $Quotes = Spyc::YAMLLoad('tests/resources/yaml/quotes.yaml');
    ...
    {
        $Failing = Spyc::YAMLLoad('tests/resources/yaml/failing1.yaml');
